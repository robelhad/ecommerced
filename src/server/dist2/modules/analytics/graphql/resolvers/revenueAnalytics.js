...
const revenueAnalytics = {
    Query: {
        revenueAnalytics: (_1, _a, _b) => __awaiter(void 0, [_1, _a, _b], void 0, function* (_, { params }, { prisma }) {
            ...
            const currentOrderItems = yield (0, analytics_1.fetchData)(prisma, "orderItem", "createdAt", currentStartDate, endDate, yearStart, yearEnd, undefined, { variant: true });
            ...
            const previousOrderItems = fetchPrevious
                ? yield (0, analytics_1.fetchData)(prisma, "orderItem", "createdAt", previousStartDate, previousEndDate, yearStart, yearEnd, undefined, { variant: true })
                : [];
            ...
            const ordersForTrends = yield (0, analytics_1.fetchData)(prisma, "order", "createdAt", yearStart, yearEnd);
            const orderItemsForTrends = yield (0, analytics_1.fetchData)(prisma, "orderItem", "createdAt", yearStart, yearEnd, undefined);
            const usersForTrends = yield (0, analytics_1.fetchData)(prisma, "user", "createdAt", yearStart, yearEnd);
