...
const configureV1Routes = (io) => {
    ...
    console.log(path_1.default.join(process.cwd(), "../../assets/seed-images/products"));
    router.use("/image", express_2.default.static(path_1.default.join(process.cwd(), "../../assets/seed-images/products")));
    // Serve category images
    router.use("/catimage", express_2.default.static(path_1.default.join(process.cwd(), "../../assets/seed-images/categories")));
    return router;
};
